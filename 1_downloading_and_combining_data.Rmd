...
new_splits <- str_split_fixed(new_links,'/',5)

new_dataset <- new_splits[,5] 

new_file_names <- paste0('data/',dataset)

map2(new_links,new_file_names,download.file)
...
meteor_files <- list.files('data',pattern='.txt',full.names=T)
...
meteor_data_full <- map_dfr(meteor_files,meteor_reader)
